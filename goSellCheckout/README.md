...
| onLoad                  | function                                     | **optional** |                                                                                                                                                                                                                                                                                                    | define an action or piece of code to be executed when the page ready to load on the screen. for example, add this function to call `goSell.openLightBox()` or `goSell.openPaymentPage()`, if you used `goSell.config()` on action event.                                                                                                                                                                    |
| onClose                 | function                                     | **optional** |                                                                                                                                                                                                                                                                                                    | Define an action or piece of code to be executed on the close event.                                                                                                                                                                                                                                                                                                                                               |
