...
| items         | Array  | **optional** | null          | Items details in the following format: <br><br> items: [<br> {<br> id: 0,<br> name: "Item ",<br> description: "Item Desc 0",<br> old_quantity: 1,<br> quantity: 1,<br> amount_per_unit: 0,<br> old_total_amount: 0,<br> total_amount: 10,<br> },<br>]<br> |
