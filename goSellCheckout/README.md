...
| shipping      | Object | **optional** | null          | Shipping details in the following fomrat:<br><br> shipping: [ <br> { <br>"amount": 1,<br> "currency": "KWD",<br> "description": "test",<br> "provider": "ARAMEX",<br> "service": "test"<br>} <br> ]                                                                    |
